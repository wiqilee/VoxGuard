...
export const DEMO_SCRIPTS = {
  en: [
    ...
    {
      id: 'en_ai_voice',
      callerNumber: '+1 (XXX) XXX-XX39',
      title: 'AI Voice Clone',
      severity: 'critical',
      description: 'Caller uses AI-cloned voice of a relative to extract money.',
      dialog: [
        { speaker:'caller', text:'Mom? Mom, it is me. Please, I am in serious trouble right now.', time:'00:02', delay:0 },
        { speaker:'me', text:'Honey? Is that you? You sound a little different.', time:'00:06', delay:4000 },
        { speaker:'caller', text:'I have a bad cold, that is why my voice sounds off. Listen, I was in a car accident and the police are here. They say I was at fault and I need to post bail immediately or they will take me to jail.', time:'00:16', delay:10000 },
        { speaker:'me', text:'Oh my God! Are you hurt? Where are you?', time:'00:20', delay:4000 },
        { speaker:'caller', text:'I am okay physically but I am terrified. My lawyer says I need $8,000 for bail. Can you wire it right now? And please do not call Dad or my regular number, the police took my phone and I am using a friend\'s.', time:'00:32', delay:12000, flagged:true },
        { speaker:'me', text:'$8,000? That is a lot of money...', time:'00:36', delay:4000 },
        { speaker:'caller', text:'Mom please, they are about to take me away! The lawyer is standing right here, he says the wire transfer has to go through in the next 20 minutes or I spend the night in a cell. Please Mom, I am begging you.', time:'00:47', delay:11000, flagged:true },
      ],
      alerts: [
        { id:1, time:'00:16', severity:'high', pattern:'Family Impersonation', quote:'"Car accident, need bail immediately."', confidence:91, tactics:['FEAR','RECIPROCITY'], source:'FBI IC3 2024' },
        { id:2, time:'00:16', severity:'high', pattern:'Deepfake Video Call', quote:'AI voice impersonation detected.', confidence:88, tactics:['RECIPROCITY','AUTHORITY'], source:'GASA 2024' },
        { id:3, time:'00:32', severity:'critical', pattern:'Wire Transfer Instruction', quote:'"Wire $8,000 right now."', confidence:96, tactics:['FEAR','URGENCY'], source:'FBI IC3 2024' },
        { id:4, time:'00:32', severity:'high', pattern:'Isolation Tactic', quote:'"Do not call Dad or my regular number."', confidence:93, tactics:['ISOLATION','FEAR'], source:'FTC Sentinel' },
        { id:5, time:'00:47', severity:'critical', pattern:'Artificial Urgency', quote:'"20 minutes or I spend the night in a cell."', confidence:95, tactics:['SCARCITY','FEAR'], source:'FBI IC3 2024' },
      ],
    },
    {
      id: 'en_digital_arrest',
      callerNumber: '+1 (XXX) XXX-XX56',
      title: 'Digital Arrest',
      severity: 'critical',
      description: 'Caller impersonates law enforcement, forces victim to stay on video call.',
      dialog: [
        { speaker:'caller', text:'This is Officer Williams from the Federal Cyber Crime Division. Your identity has been linked to a money laundering operation.', time:'00:03', delay:0 },
        { speaker:'me', text:'What? I have not done anything illegal!', time:'00:08', delay:5000 },
        { speaker:'caller', text:'We have evidence that your Social Security number was used to open fraudulent bank accounts. Fourteen complaints have been filed against you.', time:'00:18', delay:10000 },
        { speaker:'me', text:'This must be a mistake.', time:'00:23', delay:5000 },
        { speaker:'caller', text:'I need you to switch to a video call right now so we can verify your identity. You are required to stay on this call until the investigation is complete. If you disconnect, a warrant will be issued for your arrest within the hour.', time:'00:35', delay:12000, flagged:true },
        { speaker:'me', text:'Stay on video call? For how long?', time:'00:39', delay:4000 },
        { speaker:'caller', text:'Until we clear your name. I need your Social Security number and your bank account details. You must also transfer your funds to a government-secured holding account. Do not contact anyone, including your bank. This is classified.', time:'00:52', delay:13000, flagged:true },
      ],
      alerts: [
        { id:1, time:'00:03', severity:'critical', pattern:'Government Impersonation', quote:'"Federal Cyber Crime Division, money laundering."', confidence:97, tactics:['AUTHORITY','FEAR'], source:'FBI IC3 2024' },
        { id:2, time:'00:35', severity:'critical', pattern:'Digital Arrest (IN/SEA)', quote:'"Stay on video call or warrant issued."', confidence:96, tactics:['AUTHORITY','ISOLATION'], source:'GASA 2024' },
        { id:3, time:'00:52', severity:'critical', pattern:'OTP / Credential Extraction', quote:'"SSN and bank account details."', confidence:99, tactics:['AUTHORITY','COMMITMENT'], source:'FBI IC3 2024' },
        { id:4, time:'00:52', severity:'critical', pattern:'Safe Account Transfer', quote:'"Transfer to government-secured account."', confidence:98, tactics:['AUTHORITY','FEAR'], source:'FTC Sentinel' },
        { id:5, time:'00:52', severity:'high', pattern:'Isolation Tactic', quote:'"Do not contact anyone. Classified."', confidence:94, tactics:['ISOLATION','AUTHORITY'], source:'FBI IC3 2024' },
      ],
    },
    {
      id: 'en_job',
      callerNumber: '+1 (XXX) XXX-XX28',
      title: 'Job Offer Scam',
      severity: 'high',
      description: 'Caller offers a fake remote job and demands upfront payment.',
      dialog: [
        { speaker:'caller', text:'Hi there! I am from the HR department of a Fortune 500 company. We reviewed your resume and would like to offer you a remote position.', time:'00:04', delay:0 },
        { speaker:'me', text:'Really? Which company?', time:'00:09', delay:5000 },
        { speaker:'caller', text:'I cannot disclose the name yet, but it pays $5,000 per month for data entry. Fully remote, flexible hours, no experience required.', time:'00:20', delay:11000 },
        { speaker:'me', text:'$5,000 a month for data entry? That is really high.', time:'00:25', delay:5000 },
        { speaker:'caller', text:'We value quality talent. To proceed, you need to purchase a certified training kit for $299. This covers background check, software, and equipment. Fully reimbursed in your first paycheck.', time:'00:38', delay:13000, flagged:true },
        { speaker:'me', text:'I have to pay upfront?', time:'00:42', delay:4000 },
        { speaker:'caller', text:'Standard for remote positions at this level. Only three spots left, filling fast. Send $299 via gift card or crypto within the hour to secure your spot.', time:'00:54', delay:12000, flagged:true },
      ],
      alerts: [
        { id:1, time:'00:20', severity:'high', pattern:'Employment / Job Offer Scam', quote:'"$5,000/month, no experience required."', confidence:92, tactics:['GREED','AUTHORITY'], source:'FBI IC3 2024' },
        { id:2, time:'00:38', severity:'high', pattern:'Advance Fee Fraud', quote:'"Training kit for $299, reimbursed later."', confidence:95, tactics:['GREED','COMMITMENT'], source:'FTC Sentinel' },
        { id:3, time:'00:54', severity:'critical', pattern:'Gift Card Demand', quote:'"$299 via gift card or crypto."', confidence:97, tactics:['URGENCY','SCARCITY'], source:'FBI IC3 2024' },
        { id:4, time:'00:54', severity:'high', pattern:'Artificial Urgency', quote:'"Three spots left, within the hour."', confidence:93, tactics:['SCARCITY','FEAR'], source:'GASA 2024' },
      ],
    },
  ],
  id: [
    ...
    },
    {
      ...
      dialog: [
        ...
        { speaker:'caller', text:'Tidak perlu mendaftar, ini program loyalitas pelanggan. Untuk mencairkan hadiah Anda, cukup bayar pajak hadiah sebesar satu setengah juta ke rekening perusahaan kami. Setelah itu, 50 juta langsung masuk ke rekening Anda.', time:'00:36', delay:12000, flagged:true },
      ...
      alerts: [
        ...
        { id:2, time:'00:36', severity:'high', pattern:'Advance Fee Fraud', quote:'"Bayar pajak hadiah sebesar satu setengah juta."', confidence:96, tactics:['GREED','COMMITMENT'], source:'GASA 2024' },
